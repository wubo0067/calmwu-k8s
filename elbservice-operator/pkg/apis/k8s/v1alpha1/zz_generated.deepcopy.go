...
func (in *ELBServiceSpec) DeepCopyInto(out *ELBServiceSpec) {
	*out = *in
	out.ElbInstance = in.ElbInstance
	if in.Listeners != nil {
		in, out := &in.Listeners, &out.Listeners
		*out = make([]ELBListener, len(*in))
		copy(*out, *in)
	}
	if in.Selector != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetELBInstance) DeepCopyInto(out *NetELBInstance) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetELBInstance.
func (in *NetELBInstance) DeepCopy() *NetELBInstance {
	if in == nil {
		return nil
	}
	out := new(NetELBInstance)
	in.DeepCopyInto(out)
	return out
}
