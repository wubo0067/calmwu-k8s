...
func (c *helloService) Call(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error) {
...
func (h *helloHandler) Call(ctx context.Context, in *proto1.Request, out *proto1.Response) error {
